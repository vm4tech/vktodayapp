...
import { Banner, Button, Progress } from "@vkontakte/vkui";
...
export default function BannerDesire(props) {
  return (
    <div
      onClick={() => {
        props.setActivePanel("desirePanel");
        props.setDesire(props.desire);
    ...
    >
      <Banner
        ...
        actions={
          <Button
            onClick={() => props.setActivePanel("desirePanel")}
