...
const CustomEpic = withAdaptivity(
  (props) => {
    ...
    const onRefresh = async () => {
      ...
      setRefresh(true);
      await reqGetDesires(user.current.id).then((e) => {
        setDesires([...e]);
          ...
          >
            ...
            <View id="services" activePanel={activePanel}>
              <Panel id="services">
                ...
                <PanelHeader left={<Icon24Fire width={35} height={35} />}>
                  {" "}
                  Все желания
                </PanelHeader>
              ...
              <Panel id="desire_panel">
                <PanelHeader
                  ...
                  left={
                    <PanelHeaderBack
                      onClick={() => setActivePanel("services")}
                      style={{ color: "var(--background_content)" }}
                    />
                  }
                />
                <DesirePanel
